...
export default function CompetenciaCard({ item, canModify, yaInscripto, onInscribir, onDelete }) {
  return (
...
const styles = StyleSheet.create({
  card: { 
    backgroundColor: '#fff', // Fondo blanco vuelto a poner
    borderRadius: 20, 
    padding: 15, 
    marginBottom: 12, 
    flexDirection: 'row', 
    alignItems: 'center', 
    elevation: 3, // Sombra para que resalte
    shadowColor: '#000',
  ...
  title: { fontSize: 17, fontWeight: '800', color: '#1e293b' }, // Texto oscuro
