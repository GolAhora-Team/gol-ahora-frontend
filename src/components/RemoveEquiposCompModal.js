      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
          <View style={styles.header}>
            <Text style={styles.title}>Eliminar Equipos</Text>
              ...
              return (
                ...
                >
                  <MaterialCommunityIcons 
                    ...
                    size={32} 
                    color={isSel ? "#ef4444" : (equipo.colorPrimario || '#1e293b')} 
                  />
          ...
          <View style={styles.btnRow}>
            ...
            >
              {isConfirming ? (
                ...
                <Text style={styles.confirmText}>ELIMINAR ({selected.length})</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  confirmBtn: { backgroundColor: '#ef4444', padding: 14, borderRadius: 12, flex: 0.45, alignItems: 'center' },
